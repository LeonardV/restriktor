...
benchmarks_1c <- benchmark(results_1c, model_type = "means", iter = 100, group_size = 120)
...
# Benchmarks
benchmarks_12u <- benchmark(results_12u, model_type = "means", iter = 100, group_size = 120)
...
<!-- plot(plot_out_log$plots$`H1 vs. H2`) # call separate plot -->
<!-- ``` -->
...
benchmarks_1c_border <- benchmark(results_1c_border, model_type = "means", iter = 100, group_size = 120)
# loglik diff
