...
# Apply GORIC #
set.seed(123) 
results_1c <- goric(fit, constraints = list(H1), comparison = "complement")
results_1c
```
...
# Apply GORIC #
set.seed(123) 
results_1u <- goric(fit, constraints = list(H1))
results_1u
```
...
# Apply GORIC #
set.seed(123) 
results_12u <- goric(fit, constraints = list(H1, H2))
results_12u
...
# Apply GORIC #
set.seed(123) 
results_12 <- goric(fit, constraints = list(H1, H2), comparison = "none")
results_12
...
# Apply GORIC #
set.seed(123) 
results_12 <- goric(fit, constraints = list(H1g = H1g), comparison = "complement")
results_12
round(results_12$ratio.gw, 3)
```
...
# Apply GORIC #
set.seed(123) 
results_12 <- goric(fit, constraints = list(H1m = H1m), comparison = "complement")
results_12
round(results_12$ratio.gw, 3)
```
...
# Apply GORIC #
set.seed(123) 
results_0c <- goric(fit, constraints = list(H1), comparison = "complement")
results_0c
...
# Apply GORIC #
set.seed(123) 
results_12 <- goric(fit, constraints = list(H1), comparison = "complement")
results_12
round(results_12$ratio.gw, 3)
coef(fit)
```
